...
<div class="bg-black fixed z-100 h-20 min-w-20 gap-x-3 duration-400 origin-top p-4 flex md:text-xl transition {!currentState.show ? "opacity-0" : "opacity-100"} items-center justify-center min-w-80 left-[50%] translate-x-[-50%] border-4 border-(--border-color)"
     role="alert">
